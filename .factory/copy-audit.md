...
| Copy | Words | Result |
| --- | ---: | --- |
| Drag keyframes sideways. | 3 | Pass |
| Use arrow keys for 50 ms steps. | 7 | Pass |
...
| The sketch format is not supported. | 6 | Pass |
...
| --- | --- |
| Entire saved experiment | sketch |
| Animated named value | property |
| Value at one time | keyframe |
| Current timeline position | playhead |
| Playback surface | preview |
| Temporary sample workspace | demo |
| CSS browser animation interface | Web Animations |

Catalog description: “Sketch numeric and colour motion, then export CSS, Web Animations, or JSON.” — 12 words, 75 characters, verb-first.
